...
Rollie2 is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running Rollie2 Locally

You can test your hubot by running the following.

You can start Rollie2 locally by running:
...
Then you can interact with Rollie2 by typing `Rollie2 help`.

    Rollie2> Rollie2 help

    Rollie2> animate me <query> - The same thing as `image me`, except adds a few
